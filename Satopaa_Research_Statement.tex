...
Suppose they use disjoint subsets, $U$ and $M$, of all information about the future event. See Figure \ref{InfoStr} for their information layout.
...
\vspace{-1em}
  ...
  \caption{Illustration of the Information among the Two Forecasters.
...
\cite{satopaa2014probability} advance into unexplored areas of probability aggregation by considering a dynamic context in which experts can update their beliefs at random intervals. Overall, this paper was very well received. The aggregator therein, however, is based on measurement error. Therefore,  an interesting future project is to utilize martingale theory and develop a time-series aggregator based on partial information. 
