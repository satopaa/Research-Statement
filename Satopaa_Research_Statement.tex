...
Suppose they use disjoint subsets, $U$ and $M$, of all information about the  event. This layout is shown in Figure \ref{InfoStr}.
...
In response to these shortcomings, I have collaborated closely with a government funded research group called the Good Judgment Project (\citealt{ungar2012good}) and used their large forecasting database to understand the main drivers of forecast heterogeneity.
...
The framework is not only extremely general but also provides aggregators that provably collect information from the forecasters.
%, and c.
%
