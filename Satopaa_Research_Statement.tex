...
% 
Given that the combined information $U \cup M$ would provide even stronger evidence in favor of the event, the optimal aggregate of their forecasts should be somewhat greater than $0.9$. In this simple scenario, however, all measures of central tendency aggregate to $0.9$. Therefore they fail to account for the  information heterogeneity among the forecasters.
...
The principal $\sigma$-field $\F$ holds all possible information about $Y$. 
...
In practice, however, all details of the forecasters' information are not available to the aggregator. Instead, the forecasters reflect their information only through the predictions. The optimal aggregator within the framework uses all of this revealed information to predict the value of $Y$. More specifically,  the \textit{revealed aggregator} is $X'' := \E (Y \|
